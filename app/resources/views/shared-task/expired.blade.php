...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - {{ __('Link Expired') }}</title>
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900">
                            <div class="text-center">
                                ...
                                <h3 class="mt-2 text-lg font-medium text-gray-900">{{ __('Link Expired') }}</h3>
                                <p class="mt-1 text-sm text-gray-500">{{ __('The shareable link you are trying to access has expired.') }}</p>
                                <div class="mt-6">
